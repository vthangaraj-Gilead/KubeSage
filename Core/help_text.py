...
- Example: how is rstudioworkbench namespace
...
- Supported scopes: cluster, namespace, and workload / pod.
- Example: deep analyze my cluster
- Example: deep analyze kube-system namespace
- Example: deep analyze ai-investigator-lab namespace
...
- For unhealthy workloads, namespaces, and clusters, the app can provide:
  - summary
  - evidence
  - recommendations
  - next steps
